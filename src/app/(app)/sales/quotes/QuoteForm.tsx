...
export default function QuoteForm({ initial }: { initial?: Initial }) {
  ...
  async function submit(e: React.FormEvent) {
    e.preventDefault();
    setSaving(true);
    const payload = { companyId: companyId || null, contactId: contactId || null, status, validUntil: validUntil || null, notes: notes || null, items };
    const res = await fetch(initial?.id ? `/api/quotes/${initial.id}` : '/api/quotes', {
